  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Upload file Excel để import danh sách nhân viên vào hệ thống
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-6">
            ...
            {importResult.successfulEmployees.length > 0 && (
              <div>
                <h4 className="text-sm font-semibold text-green-700 mb-2 flex items-center gap-2">
                  ...
                  Nhân Viên Đã Import Thành Công (
                  {importResult.successfulEmployees.length})
                </h4>
                ...
                <div className="max-h-40 overflow-y-auto bg-red-50 rounded-md p-3">
                  <div className="space-y-2">
                    {importResult.errors.map((error, index) => (
                      <div
                        key={index}
                        className="text-sm text-red-800 border-l-2 border-red-300 pl-2"
                      >
                        <span className="font-medium">
                          {error.employee_id || "N/A"}
                        </span>
                        : {error.error}
                      </div>
                    ))}
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          ...
          <ul className="text-sm text-gray-600 space-y-1">
            ...
            <li>
              • Các cột bắt buộc: Mã Nhân Viên, Họ Tên, Số CCCD, Phòng Ban
            </li>
