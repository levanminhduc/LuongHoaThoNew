  ...
  return (
    <Card className={`${className}`}>
      ...
      <CardContent className="space-y-6">
        <div className={`p-4 rounded-lg border ${SIGNATURE_TYPE_COLORS[signatureType]}`}>
          <h4 className="font-medium mb-2">Mô tả chức năng:</h4>
          <p className="text-sm">{SIGNATURE_TYPE_DESCRIPTIONS[signatureType]}</p>
        </div>
            ...
            <AlertDescription className="text-green-800">
              <div className="space-y-2">
                ...
                <div className="text-sm space-y-1">
                  ...
                  <p>Thời gian: {formatDateTime(existingSignature.signed_at)}</p>
              ...
              <AlertDescription className="text-blue-800">
                <div className="space-y-2">
                  ...
                  <ul className="text-sm space-y-1 list-disc list-inside">
                    <li>Tôi đã kiểm tra và xác nhận tính chính xác của dữ liệu lương tháng {month}</li>
