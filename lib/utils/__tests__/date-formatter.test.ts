...
import { formatSalaryMonth, formatSalaryMonthShort, formatDateTime, formatSignatureTime, formatCurrency, formatNumber } from '../date-formatter'
...
console.log('formatSalaryMonthShort("2024-07"):', formatSalaryMonthShort('2024-07'))
console.log('formatDateTime("2025-07-26T06:52:00Z"):', formatDateTime('2025-07-26T06:52:00Z'))
console.log('formatSignatureTime("2025-07-26T06:52:00Z"):', formatSignatureTime('2025-07-26T06:52:00Z'))
