...
export const PAYROLL_FIELD_DEFINITIONS: PayrollFieldDefinition[] = [
  ...
  {
    field: "chi_dot_1_13",
    label: "Chi Đợt 1 Tháng 13",
    description: "Số tiền chi đợt 1 lương tháng 13",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13",
    default_value: 0,
  },
  {
    field: "chi_dot_2_13",
    label: "Chi Đợt 2 Tháng 13",
    description: "Số tiền chi đợt 2 lương tháng 13",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13",
    default_value: 0,
  ...
  {
    field: "tong_luong_13",
    label: "Tổng Lương Tháng 13",
    description: "Tổng số tiền lương tháng 13 (chi đợt 1 + chi đợt 2)",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13",
    default_value: 0,
  ...
  {
    field: "so_thang_chia_13",
    label: "Số Tháng Chia Tháng 13",
    description: "Số tháng làm việc để tính lương tháng 13",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13",
    default_value: 0,
  ...
  {
    field: "tong_sp_12_thang",
    label: "Tổng Sản Phẩm 12 Tháng",
    description: "Tổng sản phẩm làm được trong 12 tháng",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13",
    default_value: 0,
  ...
  {
    field: "t13_thang_01",
    label: "Tháng 13 - Tháng 01",
    description: "Sản phẩm tháng 01 để tính lương tháng 13",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13 - Chi Tiết",
    default_value: 0,
  },
  {
    field: "t13_thang_02",
    label: "Tháng 13 - Tháng 02",
    description: "Sản phẩm tháng 02 để tính lương tháng 13",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13 - Chi Tiết",
    default_value: 0,
  ...
  {
    field: "t13_thang_03",
    label: "Tháng 13 - Tháng 03",
    description: "Sản phẩm tháng 03 để tính lương tháng 13",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13 - Chi Tiết",
    default_value: 0,
  ...
  {
    field: "t13_thang_04",
    label: "Tháng 13 - Tháng 04",
    description: "Sản phẩm tháng 04 để tính lương tháng 13",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13 - Chi Tiết",
    default_value: 0,
  ...
  {
    field: "t13_thang_05",
    label: "Tháng 13 - Tháng 05",
    description: "Sản phẩm tháng 05 để tính lương tháng 13",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13 - Chi Tiết",
    default_value: 0,
  ...
  {
    field: "t13_thang_06",
    label: "Tháng 13 - Tháng 06",
    description: "Sản phẩm tháng 06 để tính lương tháng 13",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13 - Chi Tiết",
    default_value: 0,
  ...
  {
    field: "t13_thang_07",
    label: "Tháng 13 - Tháng 07",
    description: "Sản phẩm tháng 07 để tính lương tháng 13",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13 - Chi Tiết",
    default_value: 0,
  ...
  {
    field: "t13_thang_08",
    label: "Tháng 13 - Tháng 08",
    description: "Sản phẩm tháng 08 để tính lương tháng 13",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13 - Chi Tiết",
    default_value: 0,
  ...
  {
    field: "t13_thang_09",
    label: "Tháng 13 - Tháng 09",
    description: "Sản phẩm tháng 09 để tính lương tháng 13",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13 - Chi Tiết",
    default_value: 0,
  ...
  {
    field: "t13_thang_10",
    label: "Tháng 13 - Tháng 10",
    description: "Sản phẩm tháng 10 để tính lương tháng 13",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13 - Chi Tiết",
    default_value: 0,
  ...
  {
    field: "t13_thang_11",
    label: "Tháng 13 - Tháng 11",
    description: "Sản phẩm tháng 11 để tính lương tháng 13",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13 - Chi Tiết",
    default_value: 0,
  ...
  {
    field: "t13_thang_12",
    label: "Tháng 13 - Tháng 12",
    description: "Sản phẩm tháng 12 để tính lương tháng 13",
    data_type: "number",
    is_required: false,
    category: "Lương Tháng 13 - Chi Tiết",
    default_value: 0,
