    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.error?.includes("không đúng")) {
          setError("Mật khẩu hiện tại không đúng. Nếu bạn chưa đổi mật khẩu lần nào, hãy nhập số CCCD.")
        } else if (data.error?.includes("locked")) {
          setError("Tài khoản đã bị khóa do nhập sai quá nhiều lần. Vui lòng thử lại sau.")
        } else {
          ...
          <DialogDescription>
            ...
            {mustChangePassword && (
              <span className="text-yellow-600">
                Lần đầu đổi mật khẩu, vui lòng nhập số CCCD làm mật khẩu hiện tại.
              </span>
            )}
          </DialogDescription>
        </DialogHeader>
