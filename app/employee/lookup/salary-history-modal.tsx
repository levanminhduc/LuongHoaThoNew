...
import { Loader2, Calendar, AlertCircle, Calculator, Clock, DollarSign, Gift, Shield, TrendingUp, Minus, Banknote, CheckCircle, PenTool } from "lucide-react"
...
export function SalaryHistoryModal({
  ...
  const fetchMonths = async () => {
    ...
    try {
      ...
      if (response.ok) {
        const filteredMonths = data.months.filter((m: string) => m !== currentMonth)
        ...
        <div className="space-y-4">
          ...
          {loadingPayroll && (
            <div className="flex items-center justify-center py-8">
              ...
              <span className="ml-2 text-gray-600">Đang tải thông tin lương...</span>
            </div>
          )}
              ...
              <div className="space-y-6">
                <Card>
                  ...
                  <CardContent className="space-y-1">
                    <DetailRow label="Hệ Số Làm Việc" value={payrollData.he_so_lam_viec} isNumber />
                    <DetailRow label="Hệ Số Phụ Cấp Kết Quả" value={payrollData.he_so_phu_cap_ket_qua} isNumber />
                    <DetailRow label="Hệ Số Lương Cơ Bản" value={payrollData.he_so_luong_co_ban} isNumber />
                    <DetailRow label="Lương Tối Thiểu Công Ty" value={payrollData.luong_toi_thieu_cty} isCurrency />
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-1">
                    <DetailRow label="Ngày Công Trong Giờ" value={payrollData.ngay_cong_trong_gio} isNumber />
                    <DetailRow label="Giờ Công Tăng Ca" value={payrollData.gio_cong_tang_ca} isNumber />
                ...
                <Card>
                  <CardHeader className="pb-3">
                    <CardTitle className="text-lg flex items-center gap-2">
                      ...
                      <span className="text-purple-700">Lương Sản Phẩm và Đơn Giá</span>
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-1">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-1">
                    <DetailRow label="Tiền Khen Thưởng Chuyên Cần" value={payrollData.tien_khen_thuong_chuyen_can} isCurrency />
                    <DetailRow label="Lương Học Việc PC Lương" value={payrollData.luong_hoc_viec_pc_luong} isCurrency />
                    <DetailRow label="Tổng Cộng Tiền Lương Sản Phẩm" value={payrollData.tong_cong_tien_luong_san_pham} isCurrency />
                    <DetailRow label="Hỗ Trợ Thời Tiết Nóng" value={payrollData.ho_tro_thoi_tiet_nong} isCurrency />
                    <DetailRow label="Bổ Sung Lương" value={payrollData.bo_sung_luong} isCurrency />
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-1">
                    <DetailRow label="BHXH 21.5%" value={payrollData.bhxh_21_5_percent} isCurrency />
                    <DetailRow label="PC CDCS PCCC ATVSV" value={payrollData.pc_cdcs_pccc_atvsv} isCurrency />
                    <DetailRow label="Lương Phụ Nữ Hành Kinh" value={payrollData.luong_phu_nu_hanh_kinh} isCurrency />
                    <DetailRow label="Tiền Con Bú Thai 7 Tháng" value={payrollData.tien_con_bu_thai_7_thang} isCurrency />
                    <DetailRow label="Hỗ Trợ Gửi Con Nhà Trẻ" value={payrollData.ho_tro_gui_con_nha_tre} isCurrency />
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-1">
                    <DetailRow label="Ngày Công Phép Lễ" value={payrollData.ngay_cong_phep_le} isNumber />
                    <DetailRow label="Tiền Phép Lễ" value={payrollData.tien_phep_le} isCurrency />
                  </CardContent>
                </Card>
                ...
                <Card>
                  <CardHeader className="pb-3">
                    <CardTitle className="text-lg flex items-center gap-2">
                      ...
                      <span className="text-emerald-700">Tổng Lương và Phụ Cấp Khác</span>
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-1">
                    <DetailRow label="Tổng Cộng Tiền Lương" value={payrollData.tong_cong_tien_luong} isCurrency />
                    <DetailRow label="Tiền Bốc Vác" value={payrollData.tien_boc_vac} isCurrency />
                    <DetailRow label="Hỗ Trợ Xăng Xe" value={payrollData.ho_tro_xang_xe} isCurrency />
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-1">
                    <DetailRow label="Thuế TNCN Năm 2024" value={payrollData.thue_tncn_nam_2024} isCurrency />
                    <DetailRow label="Tạm Ứng" value={payrollData.tam_ung} isCurrency />
                    <DetailRow label="Thuế TNCN" value={payrollData.thue_tncn} isCurrency />
                    <DetailRow label="BHXH BHTN BHYT Total" value={payrollData.bhxh_bhtn_bhyt_total} isCurrency />
                    <DetailRow label="Truy Thu Thẻ BHYT" value={payrollData.truy_thu_the_bhyt} isCurrency />
                  </CardContent>
                </Card>
                ...
                <div className="text-sm text-gray-500 text-center">
                  ...
                  <p className="mt-1">
                    ...
                    Vui lòng liên hệ phòng nhân sự nếu có thắc mắc.
                  </p>
                </div>
              </div>
            </ScrollArea>
