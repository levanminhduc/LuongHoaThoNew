...
export default function TestRolesPage() {
  const testAccounts = [
    ...
    },
    {
      ...
      color: "bg-blue-500",
      icon: Building2,
      permissions: ["Hoàn Thành department", "KCS department", "View/Edit payroll", "Export data"]
    },
    {
      username: "TT001",
      ...
      color: "bg-green-500",
      icon: Users,
      permissions: ["Hoàn Thành department only", "View payroll", "Team management"]
    },
    {
      username: "NV001",
  ...
  const handleLogin = async (username: string, password: string, dashboard: string) => {
    try {
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {testAccounts.map((account) => {
            ...
            return (
              <Card key={account.username} className="relative overflow-hidden">
                <div className={`absolute top-0 left-0 right-0 h-2 ${account.color}`}></div>
                ...
                <CardContent className="space-y-4">
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <p className="text-sm font-medium text-gray-700 mb-1">Thông tin đăng nhập:</p>
                  ...
                  <Button 
                    className="w-full"
                    onClick={() => handleLogin(account.username, account.password, account.dashboard)}
                  >
                    🚀 Login & Test
                  </Button>

                  <div className="text-xs text-gray-500 text-center">
                    Dashboard: <code className="bg-gray-100 px-1 rounded">{account.dashboard}</code>
                  </div>
                </CardContent>
              </Card>
            )
        ...
        <div className="mt-12 bg-white rounded-lg shadow-sm p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">📋 Hướng Dẫn Test</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-3">🔍 Các tính năng cần test:</h3>
              <ul className="space-y-2 text-sm text-gray-600">
                <li>✅ <strong>Role-based routing:</strong> Mỗi role redirect đúng dashboard</li>
                <li>✅ <strong>Data filtering:</strong> Chỉ xem được data theo quyền</li>
                <li>✅ <strong>UI permissions:</strong> Buttons/features theo role</li>
                <li>✅ <strong>API security:</strong> Không thể access API ngoài quyền</li>
                <li>✅ <strong>Department access:</strong> Trưởng phòng xem nhiều departments</li>
                <li>✅ <strong>Audit logging:</strong> Tất cả actions được log</li>
              </ul>
            </div>

            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-3">🎯 Test scenarios:</h3>
              <ul className="space-y-2 text-sm text-gray-600">
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              ...
              <li>• Test accounts chỉ dùng cho demo, production sẽ dùng real data</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">
            ...
            <a href="/admin/dashboard" className="text-blue-600 hover:underline mx-2">Admin</a> |
            <a href="/manager/dashboard" className="text-blue-600 hover:underline mx-2">Manager</a> |
            <a href="/supervisor/dashboard" className="text-blue-600 hover:underline mx-2">Supervisor</a> |
            <a href="/employee/dashboard" className="text-blue-600 hover:underline mx-2">Employee</a>
          </p>
