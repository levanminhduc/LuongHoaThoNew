...
export default function DepartmentManagementPage() {
  ...
  const getPermissionCount = (department: string) => {
    return permissions.filter(p => p.department === department && p.is_active).length
  }
    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Quản Lý Phân Quyền Department</h1>
                <p className="text-sm text-gray-600">Cấp quyền truy cập departments cho Trưởng Phòng và Tổ Trưởng</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <Button
                variant="outline"
                onClick={() => router.push("/admin/department-management/permissions")}
                className="flex items-center gap-2"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Managers Có Quyền</CardTitle>
            ...
            <Card key={dept.name} className="relative">
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  ...
                  <Badge variant={getPermissionCount(dept.name) > 0 ? "default" : "secondary"}>
              ...
              <CardContent className="space-y-4">
                ...
                {getManagersWithPermissions(dept.name).length > 0 && (
                  <div className="border-t pt-3">
                    <p className="text-sm font-medium text-muted-foreground mb-2">Managers có quyền:</p>
                ...
                <div className="flex gap-2 pt-2">
                  <Button 
                    ...
                    size="sm" 
                    className="flex-1"
                    onClick={() => router.push(`/admin/department-management/assign-permissions?department=${encodeURIComponent(dept.name)}`)}
                  >
                  ...
                  <Button 
                    ...
                    size="sm" 
                    className="flex-1"
                    onClick={() => router.push(`/admin/department-management/permissions?department=${encodeURIComponent(dept.name)}`)}
                  >
