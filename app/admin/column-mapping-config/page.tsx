...
import { type ColumnAlias, type MappingConfiguration } from "@/lib/column-alias-config"
...
export default function ColumnMappingConfigPage() {
  ...
  const handleUpdateAlias = async () => {
    ...
    try {
      const token = localStorage.getItem("admin_token")
      const response = await fetch(`/api/admin/column-aliases/${editingAlias.id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const filteredAliases = selectedField && selectedField !== "all"
    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Cấu Hình Column Mapping</h1>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Định nghĩa các tên thay thế cho các trường database để auto-mapping linh hoạt
                    </CardDescription>
                  </div>
                      ...
                      {filteredAliases.length === 0 ? (
                        ...
                        filteredAliases.map((alias) => (
                          <TableRow key={alias.id}>
                            <TableCell>
                              <div>
                                <div className="font-medium">{getFieldLabel(alias.database_field)}</div>
                                <div className="text-sm text-gray-500">{alias.database_field}</div>
                              </div>
                            </TableCell>
                            <TableCell className="font-medium">{alias.alias_name}</TableCell>
                            <TableCell>
                              <Badge className={getConfidenceColor(alias.confidence_score)}>
                          ...
                          <TableRow key={config.id}>
                            ...
                            <TableCell>
                              <Badge variant="secondary">
                                {(config as any).configuration_field_mappings?.length || 0} fields
                              </Badge>
                            </TableCell>
                            <TableCell>
          ...
          <DialogContent>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value) => setAliasForm(prev => ({ ...prev, database_field: value }))}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setAliasForm(prev => ({ ...prev, alias_name: e.target.value }))}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setAliasForm(prev => ({ ...prev, confidence_score: parseInt(e.target.value) || 80 }))}
                />
              </div>
            </div>
            ...
            <DialogFooter>
              ...
              <Button 
                ...
                disabled={loading}
              >
                {loading ? "Đang xử lý..." : (editingAlias ? "Cập nhật" : "Tạo mới")}
              </Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
